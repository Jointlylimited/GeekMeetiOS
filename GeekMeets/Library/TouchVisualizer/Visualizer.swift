...
final public class Visualizer:NSObject {
    ...
    fileprivate var config: TouchConfiguration!
...
extension Visualizer {
    ...
    public class func start(_ config: TouchConfiguration = TouchConfiguration()) {
    ...
    public func handleEvent(_ event: UIEvent) {
        ...
        for touch in event.allTouches! {
            ...
            case .ended, .cancelled:
                ...
                log(touch)
            case .regionMoved, .regionEntered, .regionExited:
                log(touch)
            }
        }
    }
