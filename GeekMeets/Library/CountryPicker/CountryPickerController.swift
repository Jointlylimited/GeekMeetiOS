...
open class CountryPickerController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        setUpTableView()
        let uiBarButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "icn_back"), style: .plain, target: self, action: #selector(CountryPickerController.crossButtonClicked(_:)))
        uiBarButtonItem.image = #imageLiteral(resourceName: "icn_back").withRenderingMode(.alwaysOriginal)
