...
protocol FirstDateInteractorProtocol {
    func callStaticPageAPI()
}

protocol FirstDateDataStore {
    //var name: String { get set }
}

class FirstDateInteractor: FirstDateInteractorProtocol, FirstDateDataStore {
