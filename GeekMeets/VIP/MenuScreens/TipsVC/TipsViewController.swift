...
class TipsViewController: UIViewController {
    ...
    func setUI()
    {
        ...
        pageMenu = CAPSPageMenu(viewControllers: controllerArray, frame: CGRect(x: 0.0, y: DeviceType.hasNotch ? (viewNavigation?.frame.height)! + 44 : ((viewNavigation?.frame.height)! + 44), width: self.view.frame.width, height: DeviceType.hasNotch ? ((self.view.frame.height - 44)  - 50) : ((self.view.frame.height - 44)  - 30)), pageMenuOptions: parameters)
